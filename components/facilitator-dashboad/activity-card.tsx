...
export function ActivityCard() {
    return (
        <Card className="bg-stone-50 border border-gray-300 rounded-2xl max-w-5xl mx-auto">
            <CardContent className="px-8">
                ...
                <div className="flex items-start justify-between">
                    <div className="flex flex-col space-y-6 flex-1 max-w-[350px]">
                        {/* Companies Section */}
                        <div className="space-y-3 bg-white p-6 rounded-lg">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <Button
                                    variant="link"
                                    className="text-gray-500 p-0 h-auto text-sm hover:text-gray-700 ml-auto"
                                >
                                    See All →
                                </Button>
                            </div>
                            ...
                            <div className="flex gap-12 justify-around items-center">
                                ...
                                <div className="text-left">
                                    <div className="text-gray-600 text-sm mb-1">Onboarded</div>
                                    <div className="text-3xl font-bold text-gray-900">123</div>
                                </div>
                            </div>
                        ...
                        <div className="space-y-3 bg-white p-6 rounded-lg">
                            ...
                            <div className="flex items-center gap-3">
                                ...
                                <span className="text-gray-700 font-medium">Agents</span>
                                <Button
                                    variant="link"
                                    className="text-gray-500 p-0 h-auto text-sm hover:text-gray-700 ml-auto"
                                >
                    ...
                    <div className="flex-shrink-0 relative">
                        ...
                        />
                        <Button className="absolute bottom-0 right-4 bg-gray-900 text-white hover:bg-gray-800 rounded-lg px-4 py-2 flex items-center gap-2">
