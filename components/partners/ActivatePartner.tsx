...
interface ActivatePartnerProps {
  id: string;
}

const ActivatePartner = ({ id }: ActivatePartnerProps) => {
  ...
  return (
    <AlertDialog open={open} onOpenChange={setOpen}>
      ...
      <AlertDialogContent className="w-[95%] md:w-[40rem] border-t-4 border-t-verido-green flex justify-center mt-[10vh] gap-10 flex-col h-[12rem]">
