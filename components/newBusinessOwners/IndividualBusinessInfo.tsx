...
import IndividualBusinessInfoCard from "./IndividualBusinessInfoCard";
    ...
    <div className="w-full h-full p-2 lg:p-0">
      {businessData && (
        <div className="flex flex-col p-2 gap-2">
          <IndividualBusinessInfoCard business={businessData.response} />
...
export default IndividualBusinessInfo;
